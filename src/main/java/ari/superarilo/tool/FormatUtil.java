...
public class FormatUtil {
    ...
    private final String idNameRegex = "^[a-zA-Z0-9_]+$";
    private final String nameRegex = "^[a-zA-Z0-9\\u4e00-\\u9fa5]+$";
    ...
    public boolean checkIdName(String content) {
        return content.matches(this.idNameRegex);
    }
    public boolean checkName(String content) {
        return content.matches(this.nameRegex);
    }
}
