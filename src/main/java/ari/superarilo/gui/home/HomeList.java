...
public class HomeList extends InitGui {
    ...
    public HomeList(Ari instance, Player player) {
        ...
        this.instance.getConfigFiles().getObject(FilePath.HomeList.getName());
        this.gui = instance.getConvert().yamlConvertToObj(this.instance.getConfigFiles().getObject(FilePath.HomeList.getName()).saveToString(), HomeListGUI.class);
